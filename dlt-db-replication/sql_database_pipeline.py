...
def load_select_tables_from_database() -> None:
    ...
    This sources data from the tpcds dataset in postgres and puts it in motherduck.
    """
    # Create a pipeline
    ...
    #     "mysql+pymysql://pg2mdro@mysql-pg2md-public.ebi.ac.uk:4497/pg2md"
    # )
    ...
    source_2 = sql_database().with_resources("call_center", "catalog_page")
...
#     genome = sql_table(
#         credentials="mysql+pymysql://pg2mdro@mysql-pg2md-public.ebi.ac.uk:4497/pg2md",
#         table="genome",
#         reflection_level="full_with_precision",
#         defer_table_reflect=True,
#     )
...
#     # Create a pipeline
#     pipeline = dlt.pipeline(
#         pipeline_name="pg2md_cx",
#         destination='motherduck',
#         dataset_name="pg2md_data_arrow_4",
#     )
...
#         "mysql+pymysql://pg2mdro@mysql-pg2md-public.ebi.ac.uk:4497/pg2md?&binary_prefix=true",
#         backend="pyarrow",
...
#         pipeline_name="pg2md_cx",
#         destination='motherduck',
#         dataset_name="pg2md_data_pandas_2",
#     )
...
#     os.environ["SOURCES__SQL_DATABASE__FAMILY__INCLUDED_COLUMNS"] = '["pg2md_acc", "description"]'
