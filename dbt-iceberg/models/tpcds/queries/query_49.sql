                ...
                from
                    (
                        select
                            ...
                            (
                                cast(
                                    sum(coalesce(wr.wr_return_quantity, 0)) as decimal(
                                        15, 4
                                    )
                                ) / cast(
                ...
                from
                    (
                        select
                            ...
                            (
                                cast(
                                    sum(coalesce(cr.cr_return_quantity, 0)) as decimal(
                                        15, 4
                                    )
                                ) / cast(
                            ...
                            (
                                cast(
                                    sum(coalesce(cr.cr_return_amount, 0)) as decimal(
                                        15, 4
                                    )
                                ) / cast(
                ...
                from
                    (
                        select
                            ...
                            (
                                cast(
                                    sum(coalesce(sr.sr_return_quantity, 0)) as decimal(
                                        15, 4
                                    )
                                ) / cast(
                        ...
                        from {{ ref("store_sales") }} sts
                        left outer join
                            {{ ref("store_returns") }} sr
                            on (
