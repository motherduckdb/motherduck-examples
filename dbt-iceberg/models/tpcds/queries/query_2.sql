...
from
    (
        ...
        where {{ ref("date_dim") }}.d_week_seq = wswscs.d_week_seq and d_year = 2001
    ) y,
    (
        select
        ...
        from wswscs, {{ ref("date_dim") }}
        where {{ ref("date_dim") }}.d_week_seq = wswscs.d_week_seq and d_year = 2001 + 1
    ) z
