...
from
    (
        ...
        where
            ...
            and (
                {{ ref("date_dim") }}.d_dom between 1 and 3
                or {{ ref("date_dim") }}.d_dom between 25 and 28
            )
            and (
                {{ ref("household_demographics") }}.hd_buy_potential = '>10000'
                or {{ ref("household_demographics") }}.hd_buy_potential = 'Unknown'
            )
            ...
            and {{ ref("store") }}.s_county = 'Williamson County'
